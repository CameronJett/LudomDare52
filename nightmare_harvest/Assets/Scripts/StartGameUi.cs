...
public class StartGameUi : MonoBehaviour
{
	...
	public void StartGame()
	{
		...
		player.transform.SetPositionAndRotation(new Vector3(0, (float)-2.352596, 0), player.transform.rotation);
		camera.transform.SetPositionAndRotation(new Vector3(0, (float)-2.352596, camera.transform.position.z), player.transform.rotation);
